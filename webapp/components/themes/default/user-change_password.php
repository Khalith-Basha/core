...
echo osc_private_user_menu(); ?>
                ...
                <div id="main" class="modify_profile">
                    <h2><?php
_e('Change your password', 'modern'); ?></h2>
                    <form action="<?php
...
_e('Current password', 'modern'); ?> *</label>
                                <input type="password" name="password" id="password" value="" />
                            </p>
                            <p>
                                <label for="new_password"><?php
_e('New password', 'modern'); ?> *</label>
                                <input type="password" name="new_password" id="new_password" value="" />
                            </p>
                            <p>
                                <label for="new_password2"><?php
_e('Repeat new password', 'modern'); ?> *</label>
