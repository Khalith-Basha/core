                    ...
                    <form action="<?php echo $urlFactory->getBaseUrl(true); ?>" method="post">
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <span class="update">
                                    <?php echo osc_user_email( $user ); ?><br />
                                    <a href="<?php echo $userUrls->osc_change_user_email_url(); ?>"><?php _e('Modify e-mail', 'modern'); ?></a> <a href="<?php echo $userUrls->osc_change_user_password_url(); ?>" ><?php _e('Modify password', 'modern'); ?></a>
                                </span>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <?php $userForm->country_select(osc_get_countries(), ( $user )); ?>
                            </div>
                            <div class="row">
                                <label for="region"><?php _e('Region', 'modern'); ?> *</label>
                                <?php $userForm->region_select(osc_get_regions(), ( $user )); ?>
                            </div>
                            <div class="row">
                                <label for="city"><?php _e('City', 'modern'); ?> *</label>
                                <?php $userForm->city_select(osc_get_cities(), ( $user )); ?>
                            </div>
                            <div class="row">
