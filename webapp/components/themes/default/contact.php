...
_e('optional', 'modern'); ?>)</label> <?php $contactForm->the_subject(); ?><br />
                            <label for="message"><?php
_e('Message', 'modern'); ?></label> <?php $contactForm->your_message(); ?><br />
                            <label for="yourName"><?php
_e('Your name', 'modern'); ?> (<?php
_e('optional', 'modern'); ?>)</label> <?php $contactForm->your_name(); ?><br />
                            <label for="yourEmail"><?php
_e('Your e-mail address', 'modern'); ?></label> <?php $contactForm->your_email(); ?><br />
