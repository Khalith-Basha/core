...
echo osc_private_user_menu(); ?>
                ...
                <div id="main" class="modify_profile">
                    <h2><?php
_e('Update your profile', 'modern'); ?></h2>
                    <?php
...
_e('E-mail', 'modern'); ?></label>
                                <span class="update">
                                    <?php
echo osc_user_email(); ?><br />
                                    <a href="<?php
echo osc_change_user_email_url(); ?>"><?php
_e('Modify e-mail', 'modern'); ?></a> <a href="<?php
echo osc_change_user_password_url(); ?>" ><?php
_e('Modify password', 'modern'); ?></a>
                                </span>
                            </div>
                            <div class="row">
                                <label for="user_type"><?php
_e('User type', 'modern'); ?></label>
                                <?php
UserForm::is_company_select(osc_user()); ?>
                            </div>
                            <div class="row">
                                <label for="phoneMobile"><?php
_e('Cell phone', 'modern'); ?></label>
                                <?php
UserForm::mobile_text(osc_user()); ?>
                            </div>
                            <div class="row">
                                <label for="phoneLand"><?php
_e('Phone', 'modern'); ?></label>
                                <?php
