<?php
    ...
    if( !defined('AUTO_UPGRADE') ) {
        ...
        if( Params::getParam('skipdb') == '' ){
            if(!$error_queries[0]) {
                ...
                $message .= "<br/><br/>" . sprintf(__('These errors could be false-positive errors. If you\'re sure that is the case, you could <a href="%s">continue with the upgrade</a>, or <a href="http://forums.opensourceclassifieds.org/">ask in our forums</a>.'), $skip_db_link);
    ...
    if(Params::getParam('action') == '') {
        $title   = 'OpenSourceClassifieds &raquo; Updated correctly' ;
        $message = 'OpenSourceClassifieds has been updated successfully. <a href="http://forums.opensourceclassifieds.org/">Need more help?</a>';
        osc_die($title, $message) ;
    }
