...
function get_solution_requirements( ) {
    $array = array(
        'PHP version >= 5.x' => 'PHP5 is required to run OpenSourceClassifieds. You may talk with your hosting to upgrade your PHP version.',
        ...
        'Folder <code>components/uploads</code> exists' => 'You have to create <code>uploads</code> folder, i.e.: <code>mkdir ' . ABS_PATH . '/components/uploads/</code>' ,
        'Folder <code>components/uploads</code> is writable' => 'Folder <code>uploads</code> has to be writable, i.e.: <code>chmod a+w ' . ABS_PATH . '/components/uploads/</code>',
        'Folder <code>components/languages</code> exists' => 'You have to create <code>languages</code> folder, i.e.: <code>mkdir ' . ABS_PATH . '/components/languages/</code>',
        'Config directory is writable' => 'Config folder has to be writable, i.e.: <code>chmod a+w ' . DEFAULT_CONFIG_FOLDER_PATH . '</code>',
        'File <code>' . DEFAULT_CONFIG_PATH . 'php</code> is writable' => 'File <code>' . DEFAULT_CONFIG_PATH . '</code> has to be writable, i.e.: <code>chmod a+w ' . DEFAULT_CONFIG_PATH . '</code>',
        'File <code>' . SAMPLE_CONFIG_PATH . '</code> exists' => 'File <code>' . SAMPLE_CONFIG_PATH . '</code> is required, you should download OpenSourceClassifieds again.'
    );
    return $array;
}
