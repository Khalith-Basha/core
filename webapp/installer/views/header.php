<?php
$javaScripts = array(
	get_absolute_url() . '/static/scripts/jquery.js',
	get_absolute_url() . '/installer/data/jquery-ui.js',
	get_absolute_url() . '/installer/data/vtip/vtip.js',
	get_absolute_url() . '/installer/data/jquery.jsonp.js',
	get_absolute_url() . '/installer/data/install.js',
	get_absolute_url() . '/administration/themes/modern/js/location.js'
);
?>
<!DOCTYPE HTML>
