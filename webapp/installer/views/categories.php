...
<form id="category_form" action="index.php?step=5" method="POST">
    ...
    <div class="form-table">
        ...
        <div class="select-categories">
            ...
            <div class="left">
		<h3>Select your classified categories <span style="font-size:11px;">or</span> <a href="index.php?step=5">Skip</a></h3>
		<p>You can add/remove categories after the installation, using the admin dashboard.</p>
            </div>
        </div>
