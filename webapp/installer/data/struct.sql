...
CREATE  TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_city (
  ...
  CONSTRAINT t_city_ibfk_1
    ...
    REFERENCES /*TABLE_PREFIX*/t_region (pk_i_id ),
...
CREATE  TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_city_area (
  ...
  CONSTRAINT t_city_area_ibfk_1
    ...
    REFERENCES /*TABLE_PREFIX*/t_city (pk_i_id ))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE  TABLE IF NOT EXISTS /*TABLE_PREFIX*/acl_role (
...
CREATE  TABLE IF NOT EXISTS /*TABLE_PREFIX*/user (
  ...
  CONSTRAINT t_user_ibfk_4
    ...
    REFERENCES /*TABLE_PREFIX*/t_city_area (pk_i_id ),
  CONSTRAINT fk_user_acl_role1
    FOREIGN KEY (role_id )
    REFERENCES /*TABLE_PREFIX*/acl_role (id )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE  TABLE IF NOT EXISTS /*TABLE_PREFIX*/item (
  ...
  CONSTRAINT t_item_ibfk_3
    ...
    REFERENCES /*TABLE_PREFIX*/t_currency (pk_c_code )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE  TABLE IF NOT EXISTS /*TABLE_PREFIX*/latest_searches (
...
CREATE  TABLE IF NOT EXISTS /*TABLE_PREFIX*/bad_word (
...
CREATE  TABLE IF NOT EXISTS /*TABLE_PREFIX*/acl_permission (
  id INT UNSIGNED NOT NULL AUTO_INCREMENT ,
...
CREATE  TABLE IF NOT EXISTS /*TABLE_PREFIX*/acl_role_permission (
  role_id INT UNSIGNED NOT NULL ,
  ...
  CONSTRAINT fk_acl_role_has_acl_permission_acl_permission1
    ...
    REFERENCES /*TABLE_PREFIX*/acl_permission (id )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
