        ...
        function doModel() {
            switch ($this->action)
            {
                ...
                case 'disable_selected':    $msg = _m('Selected languages have been disabled for the website') ;
                                            ...
                                            $this->redirectTo(osc_admin_base_url(true) . '?page=languages') ;
                break;
                case 'enable_bo_selected':  $msg = _m('Selected languages have been enabled for the backoffice (administration)') ;
                                            ...
                                            $this->redirectTo(osc_admin_base_url(true) . '?page=languages') ;
                break;
                case 'disable_bo_selected': $msg = _m('Selected languages have been disabled for the backoffice (administration)') ;
