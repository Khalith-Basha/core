<?php
                                        ...
                                        switch ($location_action) {
                                            case('add_country'):    // add country
                                                                    ...
                                                                    if(isset($exists['s_name'])) {
                                                                        ...
                                                                        $countries_json = osc_file_get_contents('http://geo.opensourceclassifieds.org/geo.download.php?action=country_code&term=' .
                                                                        ...
                                                                        if(isset($countries->error)) { // Country is not in our GEO database
                                                                            ...
                                                                            $regions_json = osc_file_get_contents('http://geo.opensourceclassifieds.org/geo.download.php?action=region&country_code=' .
                                                                                        ...
                                                                                        if(!isset($regions->error)) {
                                                                                            if(count($regions) > 0) {
                                                                                                foreach($regions as $region) {
                                                                                                    $cities_json = osc_file_get_contents('http://geo.opensourceclassifieds.org/geo.download.php?action=city&country=' .
    ...
    <IfModule mod_rewrite.c>
        ...
        function install_location_by_country() {
            ...
            $countries_json = osc_file_get_contents('http://geo.opensourceclassifieds.org/geo.download.php?action=country_id&term=' .
            ...
            $manager_region = new Region();
            $regions_json = osc_file_get_contents('http://geo.opensourceclassifieds.org/geo.download.php?action=region&country_id=' .
        ...
        function install_location_by_region() {
            ...
            $manager_region = new Region();
            $regions_json = osc_file_get_contents('http://geo.opensourceclassifieds.org/geo.download.php?action=region&country=' .
