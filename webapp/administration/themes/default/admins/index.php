...
{ ?>
	...
	echo $a['pk_i_id']; ?>' />",
                                                    "<?php
	echo $a['s_username']; ?>&nbsp;<div id='datatables_quick_edit'><a href='<?php
	echo osc_admin_base_url(true); ?>?page=admins&action=edit&amp;id=<?php
	echo $a['pk_i_id']; ?>'><?php
	...
	echo osc_admin_base_url(true); ?>?page=admins&action=delete&amp;id[]=<?php
	echo $a['pk_i_id']; ?>'><?php
	_e('Delete'); ?></a></div>",
                                                    "<?php
	echo addcslashes($a['s_name'], '"'); ?>",
                                                    "<?php
	echo $a['s_email']; ?>"
                                            ] <?php
	echo $last_id != $a['pk_i_id'] ? ',' : ''; ?>
                                    <?php
} ?>
                            ],
                            "aoColumns": [
...
_e('Admins'); ?></div>
                    <a href="<?php
echo osc_admin_base_url(true); ?>?page=admins&action=add" id="button_open"><?php
_e('Add new admin'); ?></a>
