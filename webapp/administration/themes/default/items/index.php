...
_e('Date'); ?>"
            ...
            function show_filters(){
                ...
                $('#TableToolsLinks').toggle(function(){
                    if( $('#show_filter strong').html() == '+ <?php
_e('Show filters') ?>' ){
                        $('#show_filter strong').html('- <?php
_e('Show filters') ?>');
                    } else {
                        $('#show_filter strong').html('+ <?php
_e('Show filters') ?>');
...
_e('ON'); ?></option>
                                    ...
                                    <br/>
                                    <label for="i_num_bad_classified"><?php
_e('Misclassified') ?></label>
