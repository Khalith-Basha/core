...
echo $plugin_data['short_name']; ?>" />
                        ...
                        <p>
                            <?php
echo "<b>" . $plugin_data['plugin_name'] . "</b>,<br/>" . $plugin_data['description']; ?>
                            <br/>
                            <?php
_e('Select the categories where you want to apply these attributes (click on their names to expand them)'); ?>:
                        </p>
                        <p>
                            <table>
...
_e("Check all"); ?></a> - <a style="font-size: x-small; color: gray;" href="#" onclick="checkAll('frm3', false); return false;"><?php
_e("Uncheck all"); ?></a>
                                    </td>
                                    <td>
                                        <ul id="cat_tree">
