...
_e('WARNING: This will also delete the information related to this field. This action cann not be undone. Are you sure you want to continue?'); ?>');
                if(answer){
                    var url  = '<?php
echo osc_admin_base_url(true); ?>?page=ajax&action=delete_field&id='+id;
                    $.ajax({
                        url: url,
                        context: document.body,
                        success: function(res){
...
{ ?>
                        <?php
	_e("You don't have any custom fields yet"); ?> <button id="button_add" onclick="show_add();" ><?php
	_e('Add new field'); ?></button>
                    <?php
}
else
{
	...
	{ ?>
                            <li id="list_<?php
		echo $field['pk_i_id']; ?>" class="field_li <?php
		echo $even ? 'even' : 'odd'; ?>" >
                                <div class="field_div" field_id="<?php
		echo $field['pk_i_id']; ?>" >
                                    <div class="quick_edit" id="<?php
		echo "quick_edit_" . $field['pk_i_id']; ?>" style="float:left;">
                                        <?php
		echo $field['s_name']; ?> 
                                    </div>
                                    <div style="float:right;">
                                        <a onclick="show_iframe('content_list_<?php
		echo $field['pk_i_id']; ?>','<?php
		echo $field['pk_i_id']; ?>');"><?php
		_e('Edit'); ?></a>
                                        <span> | </span>
                                        <a onclick="delete_field('<?php
		echo $field['pk_i_id']; ?>');"><?php
		_e('Delete'); ?></a>
                                    </div>
                                    <div class="edit content_list_<?php
		echo $field['pk_i_id']; ?>"></div>
                                    <div style="clear: both;"></div>
