...
foreach ($dateFormats as $df) 
{
	...
	if ($df == osc_date_format()) 
	{
		...
		$checked = true;
                                                ...
                                                <input type="radio" name="df" id="<?php
	echo $df; ?>" value="<?php
	echo $df; ?>" <?php
	echo (($checked) ? 'checked="checked"' : ''); ?> onclick="javascript:document.getElementById('dateFormat').value = '<?php
	echo $df; ?>' ;"/>
                                                <label for="<?php
	echo $df; ?>"><?php
	echo date($df); ?></label><br />
                                        <?php
} ?>

                                        <input type="radio" name="df" id="df_custom" value="df_custom" <?php
echo (($custom_checked) ? 'checked="checked"' : ''); ?> />
                                        <label for="df_custom"><?php
_e('Custom'); ?>:</label> <input type="text" <?php
echo (($custom_checked) ? 'value="' . osc_date_format() . '"' : ''); ?> onkeyup="javascript:document.getElementById('dateFormat').value = this.value;"/>
...
{ ?>
                                            <option value="<?php
	echo $currency['pk_c_code'] ?>" <?php
	echo (($currentCurrency == $currency['pk_c_code']) ? 'selected="selected"' : ''); ?>><?php
	echo $currency['pk_c_code'] ?></option>
                                        <?php
} ?>
                                    </select>
                                </fieldset>
...
_e('Sunday'); ?></option>
                                        <option value="1" <?php
if (osc_week_starts_at() == '1') 
{ ?>selected="selected"<?php
} ?>><?php
_e('Monday'); ?></option>
                                        <option value="2" <?php
if (osc_week_starts_at() == '2') 
{ ?>selected="selected"<?php
} ?>><?php
_e('Tuesday'); ?></option>
                                        <option value="3" <?php
if (osc_week_starts_at() == '3') 
{ ?>selected="selected"<?php
} ?>><?php
_e('Wednesday'); ?></option>
                                        <option value="4" <?php
if (osc_week_starts_at() == '4') 
{ ?>selected="selected"<?php
} ?>><?php
_e('Thursday'); ?></option>
                                        <option value="5" <?php
if (osc_week_starts_at() == '5') 
{ ?>selected="selected"<?php
} ?>><?php
_e('Friday'); ?></option>
                                        <option value="6" <?php
if (osc_week_starts_at() == '6') 
{ ?>selected="selected"<?php
} ?>><?php
_e('Saturday'); ?></option>
                                    </select>
...
foreach ($timeFormats as $tf) 
{
	...
	echo $tf; ?>" value="<?php
	echo $tf; ?>" <?php
	echo (($checked) ? 'checked="checked"' : ''); ?> onclick="javascript:document.getElementById('timeFormat').value = '<?php
	echo $tf; ?>' ;" />
                                                <label for="<?php
	echo $tf; ?>"><?php
	echo date($tf); ?></label>
...
_e('Custom'); ?>:</label> <input type="text" <?php
echo (($custom_checked) ? 'value="' . osc_time_format() . '"' : ''); ?> onkeyup="javascript:document.getElementById('timeFormat').value = this.value;"/>
...
echo osc_time_format(); ?>" />
                            ...
                            <div style="float: left; width: 50%;">
                                <fieldset>
                                    <legend><?php
_e('Number of items in the RSS'); ?></legend>
                                    <input type="text" id="num_rss_items" name="num_rss_items" value="<?php
echo osc_num_rss_items(); ?>" onblur='validateInt(this,<?php
echo osc_num_rss_items(); ?>)'/>
                                </fieldset>
                            </div>
                            ...
                            <div style="float: left; width: 50%;">
                                <fieldset>
                                    <legend><?php
_e('Number of recent items displayed at home'); ?></legend>
                                    <input type="text" name="max_latest_items_at_home" id="max_latest_items_at_home" value="<?php
echo osc_max_latest_items_at_home(); ?>" onblur='validateInt(this,<?php
echo osc_max_latest_items_at_home(); ?>)'/>
                            ...
                            <div style="float: left; width: 50%;">
                                <fieldset>
                                    <legend><?php
_e('Number of item displayed in search results'); ?></legend>
                                    <input type="text" name="default_results_per_page" id="default_results_per_page" value="<?php
echo osc_default_results_per_page_at_search(); ?>" onblur='validateInt(this,<?php
echo osc_default_results_per_page_at_search(); ?>)'/>
                                </fieldset>
                            </div>
