...
?>
        ...
        <script type="text/javascript">
            ...
            function sendEmail() {
                ...
                $.ajax({
                    "url": "<?php
echo osc_admin_base_url(true) ?>?page=ajax&action=test_mail",
                    "dataType": 'json',
...
echo osc_mailserver_ssl(); ?>" />
                                        <small><?php
_e('Options: blank, ssl or tls'); ?></small>
                                    </p>
                                    <p>
                                        <input style="height: 20px; padding-left: 4px;padding-top: 4px;" type="checkbox" <?php
echo (osc_mailserver_auth() ? 'checked="true"' : ''); ?> name="mailserver_auth" id="mailserver_auth" />
                                        <label for="mailserver_auth"><?php
_e('Enable SMTP authentication'); ?></label>
                                    </p>
                                    <p>
                                        <input style="height: 20px; padding-left: 4px;padding-top: 4px;" type="checkbox" <?php
echo (osc_mailserver_pop() ? 'checked="true"' : ''); ?> name="mailserver_pop" id="mailserver_pop" />
                                        <label for="mailserver_pop"><?php
_e('Use a POP before SMTP'); ?></label>
                                    </p>
                                </fieldset>
                            </div>
...
_e('Help'); ?></legend>
                                    <label><?php
_e('Enter your e-mail server configuration'); ?></label>
