...
{ ?>
	...
	echo (osc_use_imagick()) ? 'checked' : ''; ?>/><label for="use_imagick"><?php
	_e('Use imagick instead of GD'); ?></label>
                                    <br />
                                    <?php
...
echo (osc_keep_original_image()) ? 'checked' : ''; ?>/><label for="keep_original_image"><?php
_e('Keep original image'); ?></label>
                                    <br />
                                    <?php
_e('Keeping original image files requires extra storage. This option ensures that the original quality of the file is un-altered. Be careful when using this option.'); ?>
                            ...
                            <fieldset>
                                <legend><?php
_e('Watermark settings'); ?></legend>
                                <p style="float:left;">
                                    <input type="radio" id="watermark_none" <?php
if (!osc_is_watermark_image() && !osc_is_watermark_text()) 
{
	echo "checked";
} ?> name="watermark_type" value="none"/><label for="watermark_none">None watermark</label>
                                </p>
                                <p style="float:left;">
                                    <input type="radio" id="watermark_text" <?php
if (osc_is_watermark_text()) 
{
	echo "checked";
} ?> name="watermark_type" value="text"/><label for="watermark_text">Watermark text</label>
                                </p>
                                <p style="float:left;">
                                    <input type="radio" id="watermark_image" <?php
if (osc_is_watermark_image()) 
{
	echo "checked";
} ?> name="watermark_type" value="image"/><label for="watermark_image">Watermark image</label>
                                </p>

                                <div style="clear:both;"></div>

                                <div class="watermark_text" style="<?php
if (!osc_is_watermark_text()) 
{
	echo "display:none;";
} ?>">
...
?>
	...
	_e('Watermark color'); ?></label><br />
                                        <input type="text" maxlength="6" id="colorpickerField" value="<?php
	echo osc_watermark_text_color(); ?>" name="watermark_text_color"/>
                                    </p>
                                    <p>
                                        <label for="watermark_text"><?php
	_e('Watermark text'); ?></label><br />
                                        <input type="text" name="watermark_text" value="<?php
	echo htmlentities(osc_watermark_text(), null, "UTF-8"); ?>"/>
                                    </p>
                                    <p>
                                        <label><?php
...
{ ?>
                                    <div id="flash_message">
                                        <p><?php
	_e('Freetype library is required. How to'); ?> <a target="_blank" href="http://www.php.net/manual/en/image.installation.php"><?php
	_e('install/configure'); ?></a></p>
                                    </div>
                                    <?php
} ?>
                                </div>

                                <div class="watermark_image" style="<?php
if (!osc_is_watermark_image()) 
{
	echo "display:none;";
} ?>">
