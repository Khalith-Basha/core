                    ...
                    <div style="padding: 20px;">
                        ...
                        <?php } else { ?>
                            ...
                            <div id="flash_message">
                                <p>
                                    <?php echo sprintf(__('The theme folder %s is not writable on your server, <span class="OpenSourceClassifieds">OpenSourceClassifieds</span> can\'t upload themes from the administration panel. Please copy the theme package using FTP or SSH, or make the mentioned themes folder writable.'), osc_themes_path()); ?>
                                </p>
                                <p>
