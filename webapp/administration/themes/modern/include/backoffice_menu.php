...
<div id="left_column"> 
    <div style="padding-top: 9px;">
        <div style="float: left; padding-left: 5px; padding-top: 5px;">
            <img src="<?php
echo osc_current_admin_theme_url('images/home_icon.gif'); ?>" alt="" title="" />
        </div>
...
_e('Comments'); ?></a>
            ...
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=media">&raquo; <?php
_e('Manage media'); ?></a>
            </li>
            <li>
                <a href="<?php
...
_e('Appearance'); ?></a>
        ...
        <ul>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=appearance">&raquo; <?php
_e('Manage themes'); ?></a>
            </li>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=appearance&action=add">&raquo; <?php
_e('Add a new theme'); ?></a>
            </li>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=appearance&action=widgets">&raquo; <?php
_e('Add or remove widgets'); ?></a>
            </li>
        </ul>
...
_e('Add a language'); ?></a>
        ...
        <h3>
            <a href="#"><?php
_e('General settings'); ?></a>
        </h3>
        <ul>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=settings">&raquo; <?php
_e('General settings'); ?></a>
            </li>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=settings&action=comments">&raquo; <?php
_e('Comments'); ?></a>
            </li>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=settings&action=contact">&raquo; <?php
_e('Contact'); ?></a>
            </li>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=settings&action=locations">&raquo; <?php
_e('Locations'); ?></a>
            </li>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=settings&action=permalinks">&raquo; <?php
_e('Permalinks'); ?></a>
            </li>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=settings&action=spamNbots">&raquo; <?php
_e('Spam and bots'); ?></a>
            </li>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=settings&action=currencies">&raquo; <?php
_e('Currencies'); ?></a>
            </li>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=settings&action=mailserver">&raquo; <?php
_e('Mail Server'); ?></a>
            </li>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=settings&action=media">&raquo; <?php
_e('Media'); ?></a>
            </li>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=settings&action=cron">&raquo; <?php
_e('Cron system'); ?></a>
            </li>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=settings&action=latestsearches">&raquo; <?php
_e('Last Searches'); ?></a>
            </li>
        </ul>
...
_e('Administrators'); ?></a>
        ...
        <ul>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=admins">&raquo; <?php
_e('List administrators'); ?></a>
            </li>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=admins&action=add">&raquo; <?php
_e('Add new administrator'); ?></a>
            </li>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=admins&action=edit">&raquo; <?php
_e('Edit Your Profile'); ?></a>
            </li>
        </ul>
...
_e('Statistics'); ?></a>
        ...
        <ul>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=stats&action=users">&raquo; <?php
_e('Users'); ?></a>
            </li>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=stats&action=items">&raquo; <?php
_e('Items'); ?></a>
            </li>
            <li>
                <a href="<?php
echo osc_admin_base_url(true); ?>?page=stats&action=comments">&raquo; <?php
_e('Comments'); ?></a>
            </li>
            <li>
                <a href="<?php
