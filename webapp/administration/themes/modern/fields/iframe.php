...
_e('Field\'s name'); ?></div>
                <div class="FormElementInput">
                    <?php
FieldForm::name_input_text($field); ?>
                </div>
...
_e('Field\'s type'); ?></div>
                <div class="FormElementInput">
                    <?php
FieldForm::type_select($field); ?>
                </div>
                <div style="clear:both;" ></div>
                <div id="div_field_options_iframe">
                    <div class="FormElementName"><?php
_e('Field\'s options (separated by commas)'); ?></div>
                    <div class="FormElementInput">
                        <?php
FieldForm::options_input_text($field); ?>
                    </div>
                </div>
                <div class="FormElement">
                    <input type="checkbox" id="field_required" name="field_required" value="1" <?php
...
_e("Preset categories"); ?></label><br />
                                <a style="font-size: x-small; color: gray;" href="#" onclick="checkAll('field_form', true); return false;"><?php
_e("Check all"); ?></a> - <a style="font-size: x-small; color: gray;" href="#" onclick="checkAll('field_form', false); return false;"><?php
_e("Uncheck all"); ?></a>
                            </td>
                            <td>
                                <ul id="cat_tree">
...
_e('Identifier name (only alphanumeric characters are allowed (a-z0-9_-)'); ?></label>
                <input type="text" name="field_slug" id="field_slug" value="<?php
echo $field['s_slug']; ?>" />
            </div>
