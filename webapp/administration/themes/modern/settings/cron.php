                        ...
                        <form action="<?php echo osc_admin_base_url(true); ?>" method="post">
                            ...
                            <div style="float: left; width: 100%;">
                                <fieldset>
                                    ...
                                    <br/>
                                    <label><?php _e('Some OpenSourceClassifieds functionalities require a cron in order to work. Check if your host isn\'t able to do them. Uncheck if you want to set up your cron manually. Refer to the manual to know more about the OpenSourceClassifieds cron system.'); ?></label>
                                </fieldset>
                            </div>
                            <div style="clear: both;"></div>
