...
_e('Regions'); ?>
                            ...
                            <div style="float:right;">
                                <a id="b_new_region" href="javascript:void(0);" style="display: none;"><?php
_e('Add new'); ?></a>
                            </div>
                            <div style="clear:both;"></div>
                        </div>
...
_e('Cities'); ?>
                            ...
                            <div style="float:right;">
                                <a id="b_new_city" href="javascript:void(0);" style="display:none;"><?php
_e('Add new'); ?></a>
                            </div>
                            <div style="clear:both;"></div>
                        </div>
        ...
        <div id="d_add_country" class="lightbox_country location" style="height: 300px;">
            <div>
                <h4><?php
_e('Add new country'); ?></h4>
            </div>
            <div style="padding: 14px;">
                <form action="<?php
echo osc_admin_base_url(true); ?>" method="POST" accept-charset="utf-8" onsubmit="return check_form_country();">
...
{ ?>
	...
	{ ?>
                        <div class="tabbertab">
                            <h2><?php
		echo $locale['s_name']; ?></h2>
                                <p>
                                    <label><?php
		_e('Country'); ?>: </label><br/>
                                    <input type="text" id="country" name="country[<?php
		echo $locale['pk_c_code']; ?>]" value="" />
                                </p>
                        </div>
                    <?php
	}; ?>
...
{ ?>
	...
	_e('Country'); ?>: </label><br/>
                            <input type="text" id="country" name="country[<?php
	echo $locales[0]['pk_c_code']; ?>]" value="" />
                        </p>
                    <?php
}; ?>
	...
	{ ?>
		...
		echo $locale['s_name']; ?></h2>
                                    <p>
                                        <label><?php
		_e('Country'); ?>: </label><br/>
                                        <input type="text" id="e_country" name="e_country[<?php
		echo $locale['pk_c_code']; ?>]" value="" />
                                    </p>
                            </div>
                        <?php
...
_e('Region'); ?>: </td>
                    ...
                    <div style="margin-top: 8px; text-align: right; ">
                        <input type="button" value="<?php
_e('Cancel'); ?>" onclick="$('#d_add_region').css('display','none');$('#fade').css('display','none');"/>
                        <input type="submit" name="submit" value="<?php
_e('Add'); ?>" />
                    </div>
                </form>
...
_e('Region'); ?>: </td>
                    ...
                    <div style="margin-top: 8px; text-align: right; ">
                        <input type="button" value="<?php
_e('Cancel'); ?>" onclick="$('#d_edit_region').css('display','none');$('#fade').css('display','none');"/>
                        <input type="submit" name="submit" value="<?php
_e('Edit'); ?>" />
                    </div>
                </form>
...
_e('City'); ?>: </td>
                    ...
                    <div style="margin-top: 8px; text-align: right; ">
                        <input type="button" value="<?php
_e('Cancel'); ?>" onclick="$('#d_add_city').css('display','none');$('#fade').css('display','none');"/>
                        <input type="submit" name="submit" value="<?php
_e('Add'); ?>" />
                    </div>
                </form>
