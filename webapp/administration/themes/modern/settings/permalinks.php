                            ...
                            <div style="float: left; width: 100%;">
                                <fieldset>
                                    ...
                                    <?php switch ($file_status) {
                                            case 3:     _e('Error. We couldn\'t write the .htaccess file on your server. Please create a file called .htaccess in the root of your OpenSourceClassifieds installation with the following content.');
                                            break;
                                            case 1:     _e('File .htaccess already exists. Please check that the .htaccess file has the following content.');
                                            break;
                                            case 2:     _e('We\'ve created a .htaccess file on the root of your OpenSourceClassifieds installation.');
                                            break;
                                          }
                                    ?>
