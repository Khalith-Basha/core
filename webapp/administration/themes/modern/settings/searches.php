                        ...
                        <form action="<?php echo osc_admin_base_url(true); ?>" method="post">
                            ...
                            <div style="float: left; width: 50%;">
                                <fieldset>
                                    ...
                                    <br/>
                                    <label><?php _e('OpenSourceClassifieds could save the latest searches users do on your site. You could have an idea of what your users are looking for or show them on the site as "hot topics".'); ?></label>
                                </fieldset>
                            </div>
