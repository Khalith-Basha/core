            ...
            <div id="right_column">
                ...
                <div id="settings_form" style="border: 1px solid #ccc; background: #eee; ">
                    <div style="padding: 20px;">
                        <?php _e('You can back up OpenSourceClassifieds here. WARNING: If you don\'t specify a backup folder, the backup files will be created in the root of your OpenSourceClassifieds installation') ; ?>
