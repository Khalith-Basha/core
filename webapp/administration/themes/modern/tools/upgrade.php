            ...
            $(function() {
                ...
                $.getJSON("http://www.opensourceclassifieds.org/latest_version.php?callback=?", function(data) {
                    if(data.version <= version) {
                        steps.innerHTML += "<?php _e('Congratulations! Your OpenSourceClassifieds installation is up to date!', 'admin'); ?>";
                    } else {
                        steps.innerHTML += "<?php _e('New version to update:', 'admin'); ?> " + data.version + "<br/>" ;
                        <?php if(Params::getParam('confirm')=='true') {?>
                            steps.innerHTML += "<img id=\"loading_image\" src=\"<?php echo osc_current_admin_theme_url('images/loading.gif') ; ?>\" title=\"\" alt=\"\" /><?php _e('Upgrading your OpenSourceClassifieds installation (this could take a while): ', 'admin') ; ?>" ;
        ...
        <div id="content">
            ...
            <div id="right_column">
                <div id="content_header" class="content_header">
                    ...
                    <div id="content_header_arrow">&raquo; <?php _e('Upgrade OpenSourceClassifieds', 'admin'); ?></div>
